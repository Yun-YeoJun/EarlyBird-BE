...
public class OAuth2AuthenticationFilter extends AbstractAuthenticationProcessingFilter {
  ...
  protected void successfulAuthentication(
    ...
    String refresh =
        createJWTRefreshTokenService.createRefreshToken(userDTO, (long) refreshTokenExpiredMs);
    ...
    OAuth2TokenDTO oAuth2TokenDTO =
        OAuth2TokenDTO.builder()
            ...
            .oAuth2ProviderName(
                OAuth2ProviderName.valueOf(request.getHeader("Provider-Name").toUpperCase()))
            .build();
