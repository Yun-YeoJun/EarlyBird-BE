...
public class JWTReissueAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
  ...
  protected void successfulAuthentication(
    ...
    String newAccessToken =
        createJWTAccessTokenService.createAccessToken(userInfo, (long) accessTokenExpiredMs);
    String newRefreshToken =
        createJWTRefreshTokenService.createRefreshToken(userInfo, (long) refreshTokenExpiredMs);
    ...
    response.addCookie(
        JWTRefreshTokenToCookieService.createCookie(newRefreshToken, refreshTokenExpiredMs));
  }
}
