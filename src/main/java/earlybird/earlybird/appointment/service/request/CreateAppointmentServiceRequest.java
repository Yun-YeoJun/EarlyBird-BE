...
public class CreateAppointmentServiceRequest {
    ...
    private CreateAppointmentServiceRequest(
            @NonNull String appointmentName, @NonNull String clientId, @NonNull String deviceToken,
            @NonNull LocalDateTime firstAppointmentTime, @NonNull Duration preparationDuration, @NonNull Duration movingDuration,
