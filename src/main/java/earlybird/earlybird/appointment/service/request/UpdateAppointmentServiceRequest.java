...
public class UpdateAppointmentServiceRequest {
    ...
    private UpdateAppointmentServiceRequest(
            Long appointmentId, String appointmentName, String clientId, String deviceToken,
            Duration preparationDuration, Duration movingDuration, LocalDateTime firstAppointmentTime,
            AppointmentUpdateType updateType, List<DayOfWeek> repeatDayOfWeekList
    ) {
