...
public class CreateAnonymousFeedbackCommentServiceRequest {
    ...
    @Builder
    private CreateAnonymousFeedbackCommentServiceRequest(String comment, String clientId, LocalDateTime createdAt) {
        this.comment = comment;
        this.clientId = clientId;
        this.createdAt = createdAt;
    }

    public static CreateAnonymousFeedbackCommentServiceRequest of(CreateFeedbackCommentRequest request) {
