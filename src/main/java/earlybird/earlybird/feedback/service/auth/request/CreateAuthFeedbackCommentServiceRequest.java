...
public class CreateAuthFeedbackCommentServiceRequest {
  ...
  @Builder
  private CreateAuthFeedbackCommentServiceRequest(
      Long id, String comment, UserAccountInfoDTO userAccountInfoDTO, LocalDateTime createdAt) {
    this.id = id;
  ...
  public static CreateAuthFeedbackCommentServiceRequest of(
      OAuth2UserDetails oAuth2UserDetails, CreateFeedbackCommentRequest requestDTO) {
