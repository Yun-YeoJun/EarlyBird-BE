...
public class AwsNotificationSchedulerManagerService implements NotificationSchedulerManager {
    ...
    private final DateTimeFormatter targetTimeFormatter = DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss");
    ...
    private Map<String, AttributeValue> createNotificationAttributeMap(Long notificationId) {
        FcmNotification notification = fcmNotificationRepository.findById(notificationId)
    ...
    private Map<String, AttributeValue> createNotificationAttributeMap(AddNotificationToSchedulerServiceRequest request) {
        String notificationTitle = request.getNotificationStep().getTitle();
        String notificationBody = request.getNotificationStep().getBody();
        String targetTime = LocalDateTime
                .ofInstant(request.getTargetTime(), ZoneId.of("Asia/Seoul"))
