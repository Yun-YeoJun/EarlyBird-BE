...
public class DeregisterNotificationServiceRequestFactory {
    ...
    public static DeregisterFcmMessageAtSchedulerServiceRequest create(
        ...
        if (updateType.equals(POSTPONE)) targetStatus = NotificationStatus.POSTPONE;
        else if (updateType.equals(MODIFY)) targetStatus = NotificationStatus.MODIFIED;
        else throw new IllegalArgumentException("Invalid update type: " + updateType);
