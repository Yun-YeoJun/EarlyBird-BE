...
public class RegisterOneNotificationAtSchedulerService implements RegisterNotificationService {
    ...
    @Override
    @Transactional
    public void register(Appointment appointment, Map<NotificationStep, Instant> notificationStepAndTargetTime) {
        ...
        if (InstantUtil.checkTimeBeforeNow(targetTime))
            return;
        ...
        AddNotificationToSchedulerServiceRequest addTaskRequest = createAddTaskRequest(
    ...
    private AddNotificationToSchedulerServiceRequest createAddTaskRequest(
            NotificationStep notificationStep, Instant targetTime,
            Appointment appointment, FcmNotification notification, String deviceToken
    ) {
