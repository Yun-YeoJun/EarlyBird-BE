...
public class RegisterFcmMessageForExistingAppointmentAtSchedulerServiceRequest {
    ...
    public static RegisterFcmMessageForExistingAppointmentAtSchedulerServiceRequest from(Appointment appointment) {

        LocalDateTime appointmentTime = appointment.getAppointmentTime().atDate(LocalDateUtil.getLocalDateNow().plusDays(2));
        LocalDateTime movingTime = LocalDateTimeUtil.subtractDuration(appointmentTime, appointment.getMovingDuration());
        LocalDateTime preparationTime = LocalDateTimeUtil.subtractDuration(movingTime, appointment.getPreparationDuration());
    ...
    public static RegisterFcmMessageForExistingAppointmentAtSchedulerServiceRequest from(
            CreateAppointmentServiceRequest request, Appointment appointment
    ) {
