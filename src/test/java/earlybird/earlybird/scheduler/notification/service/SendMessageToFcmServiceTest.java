...
// import static
// earlybird.earlybird.scheduler.notification.fcm.domain.NotificationStep.APPOINTMENT_TIME;
...
//    @Test
//    void sendMessageByToken() throws FirebaseMessagingException, ExecutionException,
...
//        FcmNotification fcmNotification = createFcmNotification(appointment, targetTime,
// APPOINTMENT_TIME);
...
//
//        SendMessageByTokenServiceRequest request = createRequest(title, body, deviceToken,
...
//                .until(() ->
// fcmNotificationRepository.findById(savedNotification.getId()).get().getStatus().equals(COMPLETED));
//
//        Optional<FcmNotification> optional =
// fcmNotificationRepository.findById(savedNotification.getId());
...
//    }
//
//    private FcmNotification createFcmNotification(Appointment appointment, LocalDateTime
// targetTime, NotificationStep notificationStep) {
...
//    }
//
//    private SendMessageByTokenServiceRequest createRequest(String title, String body, String
// deviceToken, Long notificationId) {
