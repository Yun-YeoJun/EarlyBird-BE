...
class UpdateNotificationServiceTest {
  ...
  @Mock private RegisterNotificationService registerNotificationService;

  @Mock private DeregisterNotificationService deregisterNotificationService;

  @Mock private FindAppointmentService findAppointmentService;

  @Mock private NotificationInfoFactory notificationInfoFactory;

  @InjectMocks private UpdateNotificationService updateNotificationService;
  ...
  void setUp() {
    ...
    when(findAppointmentService.findBy(appointmentId, appointment.getClientId()))
        .thenReturn(appointment);
    when(notificationInfoFactory.createTargetTimeMap(any(LocalDateTime.class), any(), any()))
        .thenReturn(notificationInfo);
  }
  ...
  void updateThenDeregisterAndRegisterNotification() {
    ...
    UpdateFcmMessageServiceRequest request =
        UpdateFcmMessageServiceRequest.builder()
